...
public class ObjectiveEntityEditForm extends AbstractEntityEditForm<Objective> {
	...
	ObjectiveEntityEditForm() {
		...
		MTextField nameField = new MTextField(I8n.Objective.Columns.NAME).withFullWidth();
		MTextField textField = new MTextField(I8n.Objective.Columns.TEXT).withFullWidth();
