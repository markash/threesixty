...
public class AssessmentEntityEditForm extends AbstractEntityEditForm<Assessment> {
    /* Assessment */
	private final ComboBox<User> managerField;
	private final ComboBox<User> employeeField;
	private final ComboBox<PeriodModel> periodField;
    /* Summary */
    private final AssessmentSummaryHeader summary;

    /* Ratings */
    private final AssessmentRatingsField ratingsField;
	...
	private final MButton addButton = new MButton("Add").withIcon(VaadinIcons.PLUS_CIRCLE).withListener(this::onAdd);
	private final MButton publishButton = new MButton("Publish").withIcon(VaadinIcons.STEP_FORWARD).withListener(this::onPublish);
	private final MButton employeeCompleteButton = new MButton("Employee Complete").withIcon(VaadinIcons.STEP_FORWARD).withListener(this::onEmployeeComplete);
	private final MButton managerCompleteButton = new MButton("Manager Complete").withIcon(VaadinIcons.STEP_FORWARD).withListener(this::onManagerComplete);
	private final MButton concludeButton = new MButton("Conclude").withIcon(VaadinIcons.STEP_FORWARD).withListener(this::onConclude);
