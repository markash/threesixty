...
public class IdentityEntityEditForm extends AbstractEntityEditForm<Identity> {
	...
	private final EntityGrid<User> userTable;
	private final String[] organisationLevelPropertyNames = {"name", "type", "icon"};
	private final String[] organisationLevelHeaderNames = {"Name", "Type", "Icon"};
	private final String[] userPropertyNames = {"id", "fullName", "position"};
	private final String[] userHeaderNames = {"#", "Name", "Position"};
