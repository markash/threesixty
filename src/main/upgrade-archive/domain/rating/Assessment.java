...
public class Assessment extends AbstractAuditable {
	...
	@NotNull(message = "{assessment.employee.NotNull.message}")
	private User employee;
	@ManyToOne
	@JoinColumn(name = "managerId")
	@NotNull(message = "{assessment.manager.NotNull.message}")
	...
	public Assessment(final String id) {
		super(id);
	}
