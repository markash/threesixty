...
public final class BadgeEditView extends AbstractRepositoryEntityEditView<Badge, String> {
    ...
    public static String VIEW(final String outcome) { return VIEW_NAME + (StringUtils.isBlank(outcome) ? "" : "/" + outcome); }
    public static String VIEW_NEW() { return VIEW("new_" + VIEW_NAME); }
