...
public class MStatsModel implements Serializable {
	...
	private VaadinIcons statisticIcon = VaadinIcons.ABACUS;
	
	public MStatsModel() { }
	
	public MStatsModel(String statistic, String statisticLabel, String statisticInfo, VaadinIcons statisticIcon, String styleName) {
	...
	public void setStatisticIcon(VaadinIcons statisticIcon) { this.statisticIcon = statisticIcon; }
